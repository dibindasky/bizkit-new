class ApiEndPoints {
  ...
  // [ AWS base url ]
  // static const String baseUrl = 'http://13.127.137.223';
  ...
  static const String cardShareCount = '/set-share-count/';
  ...
  static const String quickTasksRequests = '/quick-tasks-requests/';

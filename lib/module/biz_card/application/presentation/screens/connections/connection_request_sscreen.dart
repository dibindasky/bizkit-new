                                                            ...
                                                            child: InkWell(
                                                              onTap: () async {
                                                                final userId = connectionController
                                                                        ...
                                                                        .fromUser ??
                                                                    '';
                                                                final followBackPossible = await connectionController.connectionRequestAcceptOrReject(
                                                                    context:
                                                                        context,
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      actions: [
                                                                        ...
                                                                        OutlinedButton(
                                                                            onPressed:
                                                                                () {
                                                                              connectionController.followbackRequest(folowbackRequest: FollowBackRequestModel(toUser: userId));
                                                                              Navigator.pop(context);
                                                                            },
                                                                            child:

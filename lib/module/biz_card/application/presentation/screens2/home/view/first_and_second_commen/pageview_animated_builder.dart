...
class HomeScreenPagviewAnimateBuilder extends StatefulWidget {
  const HomeScreenPagviewAnimateBuilder({
    Key? key,
  ...
  @override
  HomeScreenPagviewAnimateBuilderState createState() =>
      HomeScreenPagviewAnimateBuilderState();
}

class HomeScreenPagviewAnimateBuilderState
    extends State<HomeScreenPagviewAnimateBuilder> {
  late Timer _timer;
  bool next = false;

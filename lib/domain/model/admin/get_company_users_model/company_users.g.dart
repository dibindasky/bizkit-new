...
part of 'company_users.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CompanyUsers _$CompanyUsersFromJson(Map<String, dynamic> json) => CompanyUsers(
      id: json['id'] as int?,
      cardData: (json['card_data'] as List<dynamic>?)
          ?.map((e) => CardDatum.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$CompanyUsersToJson(CompanyUsers instance) =>
    <String, dynamic>{
      'id': instance.id,

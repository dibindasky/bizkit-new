...
abstract class $ProfileStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, bool hasError, String? message});
}
...
class _$InitialImpl with DiagnosticableTreeMixin implements _Initial {
  const _$InitialImpl(
      {required this.isLoading, required this.hasError, this.message});
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ProfileState(isLoading: $isLoading, hasError: $hasError, message: $message)';
  }

...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i25.ProfileRepo>(
        () => _i26.ProfileService(gh<_i15.ApiService>()));
    gh.lazySingleton<_i27.QrServiceRepo>(
        () => _i28.QRServiceImpl(gh<_i15.ApiService>()));
    gh.lazySingleton<_i29.ReminderRepo>(
        () => _i30.ReminderService(gh<_i15.ApiService>()));
    ...
    gh.factory<_i34.ConnectionRequestBloc>(
        () => _i34.ConnectionRequestBloc(gh<_i19.ConnectionRequestRepo>()));

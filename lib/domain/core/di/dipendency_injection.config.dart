...
import 'package:bizkit/application/business_logic/promt/promt_bloc.dart'
    as _i12;
import 'package:bizkit/application/business_logic/qr/qr_bloc.dart' as _i41;
...
import 'package:bizkit/data/service/connections/connections_service.dart'
    as _i21;
import 'package:bizkit/data/service/contact/contact_service.dart' as _i25;
import 'package:bizkit/data/service/notification/notification_service.dart'
    as _i27;
import 'package:bizkit/data/service/profile/profile_services.dart' as _i29;
import 'package:bizkit/data/service/qr/qr_service.dart' as _i31;
import 'package:bizkit/data/service/reminder/reminder_service.dart' as _i33;
...
import 'package:bizkit/domain/core/dio_module/dio_module.dart' as _i43;
...
import 'package:bizkit/domain/repository/service/connection_request_repo.dart'
    as _i20;
import 'package:bizkit/domain/repository/service/contact_repo.dart' as _i24;
import 'package:bizkit/domain/repository/service/notification.dart' as _i26;
import 'package:bizkit/domain/repository/service/profile_repo.dart' as _i28;
import 'package:bizkit/domain/repository/service/qr_repo.dart' as _i30;
import 'package:bizkit/domain/repository/service/reminder_repo.dart' as _i32;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i20.ConnectionRequestRepo>(
        () => _i21.ConnectionService(gh<_i16.ApiService>()));
    gh.lazySingleton<_i22.ContactLocalRepo>(
        () => _i23.ContactLocalService(gh<_i10.LocalService>()));
    gh.lazySingleton<_i24.ContactsRepo>(
        () => _i25.ContactServiceImpl(gh<_i16.ApiService>()));
    gh.lazySingleton<_i26.NotificationRepo>(
        () => _i27.NotificationService(gh<_i16.ApiService>()));
    gh.lazySingleton<_i28.ProfileRepo>(
        () => _i29.ProfileService(gh<_i16.ApiService>()));
    gh.lazySingleton<_i30.QrServiceRepo>(
        () => _i31.QRServiceImpl(gh<_i16.ApiService>()));
    gh.lazySingleton<_i32.ReminderRepo>(
        () => _i33.ReminderService(gh<_i16.ApiService>()));
    gh.factory<_i34.UserDataBloc>(() => _i34.UserDataBloc(
          gh<_i5.CardScanningRepo>(),
          gh<_i14.UserLocalRepo>(),
          gh<_i18.CardRepo>(),
        ));
    gh.factory<_i35.BusinessDataBloc>(() => _i35.BusinessDataBloc(
          gh<_i11.PdfPickerImpl>(),
          gh<_i18.CardRepo>(),
          gh<_i14.UserLocalRepo>(),
        ));
    gh.factory<_i36.CardBloc>(() => _i36.CardBloc(
          gh<_i18.CardRepo>(),
          gh<_i11.PdfPickerImpl>(),
        ));
    gh.factory<_i37.ConnectionRequestBloc>(
        () => _i37.ConnectionRequestBloc(gh<_i20.ConnectionRequestRepo>()));
    gh.factory<_i38.ContactsBloc>(() => _i38.ContactsBloc(
          gh<_i7.ContactFetchServiceRepo>(),
          gh<_i24.ContactsRepo>(),
          gh<_i22.ContactLocalRepo>(),
        ));
    gh.factory<_i39.NotificationBloc>(
        () => _i39.NotificationBloc(gh<_i26.NotificationRepo>()));
    gh.factory<_i40.ProfileBloc>(
        () => _i40.ProfileBloc(gh<_i28.ProfileRepo>()));
    gh.factory<_i41.QrBloc>(() => _i41.QrBloc(gh<_i30.QrServiceRepo>()));
    gh.factory<_i42.ReminderBloc>(
        () => _i42.ReminderBloc(gh<_i32.ReminderRepo>()));
    return this;
  }
}

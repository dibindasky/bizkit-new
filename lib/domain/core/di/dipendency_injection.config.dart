...
import 'package:bizkit/domain/repository/service/connection_repo.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i19.ConnectionRepo>(
        () => _i20.ConnectionService(gh<_i15.ApiService>()));
    gh.factory<_i21.ConnectionRequestBloc>(
        () => _i21.ConnectionRequestBloc(gh<_i19.ConnectionRepo>()));
    gh.lazySingleton<_i22.ContactLocalRepo>(
        () => _i23.ContactLocalService(gh<_i10.LocalService>()));
    gh.lazySingleton<_i24.ContactsRepo>(
        () => _i25.ContactServiceImpl(gh<_i15.ApiService>()));
    ...
    gh.factory<_i31.BusinessDataBloc>(() => _i31.BusinessDataBloc(
          gh<_i11.PdfPickerImpl>(),
          gh<_i17.CardRepo>(),
          gh<_i13.UserLocalRepo>(),
        ));
    gh.factory<_i32.CardBloc>(() => _i32.CardBloc(
          gh<_i17.CardRepo>(),
          gh<_i11.PdfPickerImpl>(),
        ));
    ...
    gh.factory<_i34.QrBloc>(() => _i34.QrBloc(gh<_i26.QrServiceRepo>()));
    gh.factory<_i35.ReminderBloc>(
        () => _i35.ReminderBloc(gh<_i28.ReminderRepo>()));
    return this;
  }
}

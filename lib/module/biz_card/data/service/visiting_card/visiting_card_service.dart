...
import 'package:bizkit/module/biz_card/domain/model/visiting_cards/create_visiting_card_responce/create_visiting_card_responce.dart';
import 'package:bizkit/module/biz_card/domain/model/visiting_cards/get_all_visiting_cards/get_all_visiting_cards.dart';
...
class VisitingCardService implements VisitingCardRepo {
  ...
  Future<Either<Failure, CreateVisitingCardResponce>> createVisitingCard(
    ...
    try {
      log('Create VIsiting cardd TOJOSN ==> ${createVisitingCard.cardImage}');

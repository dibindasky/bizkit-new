                    ...
                    return RefreshIndicator(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          List<String> parts =
                              notification.scheduledAt!.split(':');
                          int hours = int.parse(parts[0]);
                          int minutes = int.parse(parts[1]);
                          List<String> secondsAndMicroseconds =
                              parts[2].split('.');
                          int seconds = int.parse(secondsAndMicroseconds[0]);
                          int microseconds = int.parse(
                              secondsAndMicroseconds[1].padRight(6, '0'));
                          DateTime now = DateTime.now();
                          DateTime dateTime = DateTime(now.year, now.month,
                              now.day, hours, minutes, seconds, microseconds);
                          // final date =

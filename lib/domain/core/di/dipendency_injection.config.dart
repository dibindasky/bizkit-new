...
import 'package:bizkit/data/service/qr/qr_service.dart' as _i25;
...
import 'package:bizkit/domain/repository/service/qr_repo.dart' as _i24;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i17.BusinessDataBloc>(
        () => _i17.BusinessDataBloc(gh<_i11.PdfPickerImpl>()));
    gh.lazySingleton<_i18.CardRepo>(
        () => _i19.CardService(gh<_i15.ApiService>()));
    ...
    gh.lazySingleton<_i24.QrServiceRepo>(
        () => _i25.QRServiceImpl(gh<_i15.ApiService>()));
    gh.factory<_i26.UserDataBloc>(() => _i26.UserDataBloc(
          gh<_i5.CardScanningRepo>(),
          gh<_i13.UserLocalRepo>(),
          gh<_i18.CardRepo>(),
        ));
    gh.factory<_i27.CardBloc>(() => _i27.CardBloc(gh<_i18.CardRepo>()));
    gh.factory<_i28.ContactsBloc>(() => _i28.ContactsBloc(
          gh<_i7.ContactFetchServiceRepo>(),
          gh<_i22.ContactsRepo>(),
          gh<_i20.ContactLocalRepo>(),
        ));
    gh.factory<_i29.QrBloc>(() => _i29.QrBloc(gh<_i24.QrServiceRepo>()));
    return this;
  }
}
